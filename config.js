...
//
global.Owner = ["+94741698653"];         //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.OwnerNumber = ["+94741698653"];   //If you want singal number so global.Owner = ['916297175943'] Change into your number.
global.ownertag = ["+94704274987"];
global.OwnerName = "CHAKY";
global.BotName = "CHAKY";
global.packname = "🦋 │𝐂𝐘𝐁𝜩𝐑│𝐏𝜟𝐍𝐃𝐀│𝐌𝐃│𝐕➂ 🦋";                             //Do not change.
global.author = "CHAKY";                               //Do not change.
